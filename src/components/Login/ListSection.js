  ...
  return (
    <div className="list-section ">
      ...
      <ul className="list-point">
        ...
        <li className="list-line">Millions of quiz admirers like you have shown trust in us.</li>
        <li className="list-line">Challenge lakhs of players from across the world!</li>
      </ul>
    </div>
  );
}
